...
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/ufo@0.8.5/node_modules/ufo/dist/index.mjs';
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/html-tags@3.2.0/node_modules/html-tags/index.js';
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/@heroicons+vue@1.0.6/node_modules/@heroicons/vue/outline/index.js';
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/@heroicons+vue@1.0.6/node_modules/@heroicons/vue/solid/index.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-30da6826><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-30da6826></div><div class="max-w-520px text-center" data-v-30da6826><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-30da6826>${serverRenderer.exports.ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-30da6826>${serverRenderer.exports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui-templates@0.2.2/node_modules/@nuxt/ui-templates/dist/templates/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30da6826"]]);

export { error500 as default };
//# sourceMappingURL=error-500.e8d5b59c.mjs.map
