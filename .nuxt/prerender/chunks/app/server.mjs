...
import { withBase, withLeadingSlash, withoutTrailingSlash, joinURL, hasProtocol, isEqual, withQuery } from 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/ufo@0.8.5/node_modules/ufo/dist/index.mjs';
...
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/h3@0.7.14/node_modules/h3/dist/index.mjs';
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/unenv@0.5.3/node_modules/unenv/runtime/mock/proxy.mjs';
import 'stream';
...
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/unenv@0.5.3/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/hookable@5.1.1/node_modules/hookable/dist/index.mjs';
...
import 'file:///Users/nicole/dev/vvifi-fyi/node_modules/.pnpm/defu@6.0.0/node_modules/defu/dist/defu.mjs';
...
const useError = () => {
  ...
  return useState("error", () => nuxtApp.ssrContext.error, "$RExLMoFWjS");
};
...
const _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "toc" }, _attrs))} data-v-58dad79e><header class="toc-header" data-v-58dad79e><h3 class="text-xl font-bold" data-v-58dad79e>Table of contents</h3></header><ul class="toc-links" data-v-58dad79e><!--[-->`);
      serverRenderer.exports.ssrRenderList(flattenLinks(__props.links), (link) => {
        _push(`<li class="${serverRenderer.exports.ssrRenderClass(`toc-link _${link.depth}`)}" data-v-58dad79e><a${serverRenderer.exports.ssrRenderAttr("href", `#${link.id}`)} data-v-58dad79e>${serverRenderer.exports.ssrInterpolate(link.text)}</a></li>`);
      });
      _push(`<!--]--></ul></nav>`);
    };
  }
...
const __nuxt_component_1$2 = vue_cjs_prod.defineComponent({
  ...
  render(ctx) {
    ...
    if (value && (value == null ? void 0 : value._type) === "markdown" && ((_b = (_a = value == null ? void 0 : value.body) == null ? void 0 : _a.children) == null ? void 0 : _b.length)) {
      return vue_cjs_prod.h(__nuxt_component_2, {
        value,
        excerpt,
        tag,
        ...this.$attrs
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "prev-next-cont" }, _attrs))} data-v-77a8ddde><li class="link-item prev" data-v-77a8ddde>`);
      if (__props.prev) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="block" data-v-77a8ddde${_scopeId}>${serverRenderer.exports.ssrInterpolate(__props.prev.title)}</span>`);
            } else {
              return [
                vue_cjs_prod.createVNode(vue_cjs_prod.unref(ArrowLeftIcon), { class: "icon stroke" }),
                vue_cjs_prod.createVNode("span", { class: "block" }, vue_cjs_prod.toDisplayString(__props.prev.title), 1)
              ];
            }
          }),
          _: 1
      ...
      _push(`</li><li class="link-item next" data-v-77a8ddde>`);
      if (__props.next) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="block" data-v-77a8ddde${_scopeId}>${serverRenderer.exports.ssrInterpolate(__props.next.title)}</span>`);
              ...
              return [
                vue_cjs_prod.createVNode("span", { class: "block" }, vue_cjs_prod.toDisplayString(__props.next.title), 1),
...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("tags", () => queryContent("blog").only(["tags"]).find(), "$9eTPRjBQOX")), __temp = await __temp, __restore(), __temp);
...
const _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47pages_47runtime_47router = defineNuxtPlugin(async (nuxtApp) => {
...
const _plugins = [
  ...
  _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  _47Users_47nicole_47dev_47vvifi_45fyi_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_466_47node_modules_47nuxt_47dist_47pages_47runtime_47router,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.0.0-rc.6/node_modules/nuxt/dist/app/components/nuxt-root.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const _sfc_main$2 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$3;
  _push(`<header${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "site-header" }, _attrs))} data-v-21d3208b><div class="wrapper" data-v-21d3208b>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "no-underline"
  }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<figure class="site-logo" data-v-21d3208b${_scopeId}><h1 data-v-21d3208b${_scopeId}>VviFi</h1></figure>`);
      } else {
        return [
          vue_cjs_prod.createVNode("figure", { class: "site-logo" }, [
            vue_cjs_prod.createVNode("h1", null, "VviFi")
          ])
        ];
      }
    }),
  ...
  _push(`<nav class="site-nav" data-v-21d3208b><ul class="links" data-v-21d3208b><li class="link" data-v-21d3208b>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-21d3208b"]]);
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "site-footer" }, _attrs))} data-v-262f341c><p data-v-262f341c><span data-v-262f341c>\xA9 ${serverRenderer.exports.ssrInterpolate(new Date().getFullYear())} \xA0</span><a href="https://shecodez.com" target="_blank" data-v-262f341c>shecodez</a></p></footer>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-262f341c"]]);
const _sfc_main = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "min-h-screen flex flex-col" }, _attrs))}>`);
